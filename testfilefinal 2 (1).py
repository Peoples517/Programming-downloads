...
for you. The CAPITALIZED words will be your options in this game.''')
print(" ")
...
def BEGINNING():
    begin = "none"
    begin_answer = ["UNDERSTAND" , "YES" , "NOT" , "NO"]
    while begin not in begin_answer:
        begin = input(str("Do you UNDERSTAND or NOT? ")).upper()
        if begin in ["NOT" , "NO"]:
            print("Ok well don't play then...")
            time.sleep(1)
            print("You must restart.")
            BEGINNING()
        elif begin in ["UNDERSTAND" , "YES"]:
...
print("if you insist...")
print(" ")
print("Now that we know you a little better, let's begin our adventure")
time.sleep(2)
...
def FORWARD():
    ...
    print("")
    time.sleep(5)
    print_wrapped("\nAs you make your way down the dirt road you hear a faint song playing through the trees. You already are being adventurous today. Should you check it out or continue on your way?\n")
def CHECK():
...
def EAT():
    ...
    TIMELOOP()
def LEAVE():
    print_wrapped(f"\nAre you sure? I mean it’s right there!! How many times has a plate of {favorite_food} appeared in front of you ripe for the taking?! In my opinion, this is a missed opportunity on your part. You make your way back to the dirt path. ")
    time.sleep(2)
def CONTINUE():
